# -*- coding: utf-8 -*-
"""질문뽑기v4.1(gensim + LSTM +11만).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jMkDy0dUJAdyRIr-REtqO7vGUcpTFS1Z
"""
...
def interview_question(resume, interview_set=None):
  ...
  # Load Check Point
  checkpoint_path = "/data/training_ver4.2/cp-{epoch:04d}.ckpt" # 파일 이름에 에포크 번호를 포함시킵니다(`str.format` 포맷)
  checkpoint_dir = os.path.dirname(checkpoint_path)
  latest = tf.train.latest_checkpoint(checkpoint_dir) # 가장 마지막 체크포인트
  model.load_weights(latest) # 가중치 로드 (latest: 'training_ver4/cp-0050.ckpt')
  model.summary()
